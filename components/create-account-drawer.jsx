            ...
            <div className='px-4 pb-5'>
                <form action="" className='space-y-4'>
                    <div className='space-y-2'>
                        ...
                        {errors.type && (
                            <p className='text-sm bg-red-500'>{errors.type.message}</p>
                        )}
                    </div>
                </form>
            </div>
            ...
            <div className='px-4 pb-5'>
                <form action="" className='space-y-4'>
                    <div className='space-y-2'>
                        ...
                        {errors.balance && (
                            <p className='text-sm bg-red-500'>{errors.balance.message}</p>
                        )}
                    </div>
                    ...
                    <div className='flex items-center justify-between rounded-lg border p-3 '>
                        ...
                        <label htmlFor="isDefault"><p className='text-sm text-muted-foreground'>This Account will be selected by default for Transactions </p></label>
                        </div>
